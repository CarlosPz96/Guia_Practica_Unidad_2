...
public class ModeloPersona extends Persona {
    ...
    public boolean grabarPersona() {
        String sql;
        sql = "INSERT INTO persona(id_persona,nombre,apellido)";
        sql += "VALUES('" + getId_persona() + "','" + getNombre() + "','" + getApellido() + "')";
    ...
    public boolean ModificarPersona() {
        String sql;
        sql = "update persona set id_persona='" + getId_persona() + "' ,nombre='" + getNombre() + "',apellido='" + getApellido() + "' "+ "where id_persona='" + getId_persona() + "';";
